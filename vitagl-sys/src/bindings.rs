...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of SceGxmAuxiliarySurface"][::std::mem::size_of::<SceGxmAuxiliarySurface>() - 24usize];
    ["Alignment of SceGxmAuxiliarySurface"]
        [::std::mem::align_of::<SceGxmAuxiliarySurface>() - 4usize];
    ["Offset of field: SceGxmAuxiliarySurface::colorFormat"]
        [::std::mem::offset_of!(SceGxmAuxiliarySurface, colorFormat) - 0usize];
    ["Offset of field: SceGxmAuxiliarySurface::type_"]
        [::std::mem::offset_of!(SceGxmAuxiliarySurface, type_) - 4usize];
    ["Offset of field: SceGxmAuxiliarySurface::width"]
        [::std::mem::offset_of!(SceGxmAuxiliarySurface, width) - 8usize];
    ["Offset of field: SceGxmAuxiliarySurface::height"]
        [::std::mem::offset_of!(SceGxmAuxiliarySurface, height) - 12usize];
    ["Offset of field: SceGxmAuxiliarySurface::stride"]
        [::std::mem::offset_of!(SceGxmAuxiliarySurface, stride) - 16usize];
    ["Offset of field: SceGxmAuxiliarySurface::data"]
        [::std::mem::offset_of!(SceGxmAuxiliarySurface, data) - 20usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
